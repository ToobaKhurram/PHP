                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.php" class="dropdown-item">Add Category</a>
                            <a href="typography.php" class="dropdown-item">View Category</a>
                        </div>
                    </div>
                    ...
                    <a href="chart.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Feedbacks</a>
                    <div class="nav-item dropdown">
