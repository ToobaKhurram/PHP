							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="adminPanel/images/<?php echo $productDetail['image']?>" alt="IMG-PRODUCT">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<form action="shoping-cart.php" method="post">
										<input type="hidden" name="pId" value="<?php echo $productDetail['id']?>">
										<input type="hidden" name="pName"  value="<?php echo $productDetail['name']?>">
										<input type="hidden" name="pPrice" value="<?php echo $productDetail['price']?>">
										<input type="hidden" name="pImage" value="<?php echo $productDetail['image']?>">
